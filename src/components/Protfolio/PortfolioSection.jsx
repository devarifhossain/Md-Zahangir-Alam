...
const PortfolioSection = ({ data }) => {
  ...
  const getData = (imgLink, title, subTitle, description) => {
    let tempData = [imgLink, title, subTitle, description];
  ...
  return (
    <>
      ...
      {modal === true ? <Modal img={tempData[1]} title={tempData[2]} subTitle={tempData[3]} description={tempData[4]}  modalClose={modalClose} /> : ""}
    </>
  );
};
